        ...
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerInfo}>
            ...
            <Text style={styles.headerSubtitle}>
              {section.timeRange} • {totalDurationString} • {completedCount}/{totalCount}
            </Text>
          </View>
          {section.xpBonus > 0 && (
...
const styles = StyleSheet.create({
  ...
  xpText: { color: "#000", fontSize: 11, fontWeight: "700" },
  progressContainer: { marginTop: 16 },
  progressBarBg: { height: 4, backgroundColor: "#eee", borderRadius: 0, overflow: "hidden" },
  progressBarFill: { height: "100%", backgroundColor: "#000" },
  taskList: { backgroundColor: "#fff", paddingHorizontal: 16, paddingBottom: 8 },
});
